 ...
 **/
@Slf4j
public class ImplementRegistrar implements BeanFactoryAware,ImportBeanDefinitionRegistrar,ResourceLoaderAware {
    ...
    public void registerBeanDefinitions(AnnotationMetadata annotationMetadata, BeanDefinitionRegistry beanDefinitionRegistry) {
        ...
        scanner.addIncludeFilter(new AnnotationTypeFilter(Implement.class));
        ...
        for(BeanDefinition beanDefinitionHolder : beanDefinitions){
            ...
            try {
                ...
                Object proxy = Proxy.newProxyInstance(target.getClassLoader(), target.getInterfaces(), new IServiceProxy(target));
    ...
    static class IServiceProxy implements InvocationHandler {
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            log.info("ImplementRegistrar 方法名称:"+method.getName());
            log.info("ImplementRegistrar 方法参数："+method.getParameterCount());
